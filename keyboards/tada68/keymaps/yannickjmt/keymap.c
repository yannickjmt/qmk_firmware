...
[_BL] = KEYMAP_ANSI(
  ...
  KC_LCTL, KC_LGUI,KC_LALT,                KC_SPC,                        KC_RALT,TG(_NL),KC_HOME, KC_LEFT,KC_DOWN,KC_RGHT),
...
[_FL] = KEYMAP_ANSI(
   ...
   */
[_NL] = KEYMAP_ANSI(
  _______,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,   KC_7,   KC_8,   KC_9,KC_KP_SLASH,KC_KP_ASTERISK,KC_KP_EQUAL,KC_BSPC,KC_GRV, \
  _______,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,   KC_4,   KC_5,   KC_6,KC_KP_MINUS,       _______, _______,_______,KC_DEL, \
  _______,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,   KC_1,   KC_2,   KC_3, KC_KP_PLUS,       _______,         _______,KC_PGUP,  \
